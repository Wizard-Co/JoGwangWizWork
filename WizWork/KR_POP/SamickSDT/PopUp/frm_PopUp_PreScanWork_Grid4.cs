...
namespace WizWork
{
    public partial class frm_PopUp_PreScanWork_Grid4 : Form
    {
        ...
        private bool BarCodeCheck(string strBarCode)
        {
            ...
            try
            {
                if (Frm_tprc_Main.g_tBase.Process.Contains("외주"))  //Frm_tprc_Main.g_tBase.Process.Contains("도금") ||
                {
                    YLabelOK = false;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                if (Frm_tprc_Main.g_tBase.Process.Contains("외주") == true)  //Frm_tprc_Main.g_tBase.Process.Contains("도금") == true ||
                {
