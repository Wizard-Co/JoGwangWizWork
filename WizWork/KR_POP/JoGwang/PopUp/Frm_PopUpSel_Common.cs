...
namespace WizWork
{
    public partial class Frm_PopUpSel_Common : Form
    {
        ...
        public delegate void OTextEventHandler(string Custom, string InCustom, string OrderID, string BuyerArticleNo, string OrderQty, string UnitClss, string Model, string Article, string DvlyDate, string Work, string ArticleGrp, string CustomID, string ArticleID, string UnitClssID, string BuyerModelID, string WorkID, string InCustomID, string ArticleGrpID, string OK); //출고 이벤트
        ...
        private void Frm_PopUpSel_Common_Load(object sender, EventArgs e)
        {
            ...
            else //출고에서 호출
            {
                ...
                if (GBN == "MA")
                {
                    ...
                    grdData.Columns[4].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
                    grdData.Columns[1].Visible = false;
                    grdData.Columns[2].Visible = false;
                    grdData.Columns[3].Visible = false;                  
                    grdData.Columns[5].Visible = false;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                OWriteTextEvent(Custom,InCustom, OrderID, BuyerArticleNo, OrderQty, OUnitClss, Model, Article, DvlyDate, Work, ArticleGrp, CustomID, ArticleID, OUnitClssID, BuyerModelID, WorkID, InCustomID, ArticleGrpID, Ok);
            }
