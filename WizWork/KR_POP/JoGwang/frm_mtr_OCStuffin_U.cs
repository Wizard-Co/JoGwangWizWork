        ...
        private bool SaveData()
        {
            try
            {
                ...
                if (u_LotID == "")
                {
                    ...
                    //sqlParameter.Add("Inspector", cboStuffinPerson.Text.ToString());        //검수자
                    sqlParameter.Add("CreateUserID", cboStuffinPerson.SelectedValue.ToString());  //입고자 txtInspectPersonTag.Text.ToString()
        ...
        private void PrintWorkCard()
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt2.Rows)
                {
                    ...
                    list_Data.Add(Lib.CheckNull(dr["BuyerArticleNo"].ToString())); //품번 2
                    list_Data.Add(Lib.CheckNull(dr["Spec"].ToString()));//Spec 3
                    list_Data.Add(Lib.MakeDate(WizWorkLib.DateTimeClss.DF_FD, Lib.CheckNull(dr["StuffDate"].ToString())));//입고일자 4
